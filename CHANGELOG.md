- 2023-07-16:
  - Update: 7.4 official to "latest", "latest-alpine" and "latest-ubuntu" tags
  - Tag 7.4.162
...
- **2019-08-30:**
  ...
  - Tag 5.10.27 release
    - Missed this release being promoted to stable on 2019-08-20. UI community release alerts don't work if they just change the designation on an existing post... _sigh_
...
- **2018-08-21:**
  ...
  - Extend _-nom tags to _-nomongo to hopefully better clarify what they are.
...
- **2017-12-16:**
  ...
  - Change _:_/Dockerfile to use updated UniFi package download URL - https://dl.ubnt.com/unifi/$VERSION/unifi_sysvinit_all.deb
